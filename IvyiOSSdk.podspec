...
#* Don't worry about the indent, we strip it!
  ...
  s.prefix_header_file = true
   s.prefix_header_file = 'IvyiOSSdk/IvyiOSSdk.pch'
...
#  s.frameworks = 'UIKit', 'CoreFoundation', 'QuartzCore', 'AVKit', 'AdServices', 'Foundation', 'SystemConfiguration', 'CoreGraphics', 'Security'
...
#  s.public_header_files = 'IvyiOSSdk/Classes/**/*.h*'
  ...
  s.subspec 'Common' do |common|
      ...
      common.frameworks = 'StoreKit', 'SystemConfiguration', 'Security','Foundation'
      common.dependency 'SocketRocket', '0.7.0'
      common.xcconfig = { "OTHER_LDFLAGS" => '-ObjC' }
...
#  end
  ...
  s.subspec 'Appsflyer' do |appsflyer|
      ...
      appsflyer.dependency 'AppsFlyerFramework', '6.15.3' #'6.12.1'
#      appsflyer.dependency 'AppsFlyer-AdRevenue'#, '6.9.0'#'5.4.4'#, '5.2.0'
  ...
  FirebaseVersion = '11.14.0' #'10.19.0' #'10.12.0' #'8.15.0' #'6.30.0'#'6.23.0' #'6.18.0' #'6.14.0'
...
#      firebase.dependency 'BoringSSL-GRPC', '0.0.32'#'0.0.24'
  ...
  FBVersion = '17.3.0' #'14.1.0' #'12.3.2' #'13.2.0' #'11.2.1' #'6.5.2' #'7.1.1' #'6.5.1' #'5.13.0' #'5.2.1'
...
#      facebook.user_target_xcconfig = { "LIBRARY_SEARCH_PATHS" => ['${PODS_CONFIGURATION_BUILD_DIR}/FBSDKShareKit', '${PODS_CONFIGURATION_BUILD_DIR}/FBSDKLoginKit'], "HEADER_SEARCH_PATHS" => ['${PODS_ROOT}/Headers/Public/FBSDKShareKit', '${PODS_ROOT}/Headers/Public/FBSDKLoginKit']}
  ...
  s.subspec 'Google' do |google|
      ...
      google.dependency 'Google-Mobile-Ads-SDK', AdmobVersion #'10.6.0'
      #google.dependency 'PersonalizedAdConsent', '1.0.5'
      google.dependency 'GoogleMobileAdsMediationFyber', '8.3.2.1'
      google.dependency 'GoogleMobileAdsMediationIronSource', '8.4.0.0.0'
      google.dependency 'GoogleMobileAdsMediationInMobi', '10.7.8.0'
      google.dependency 'GoogleMobileAdsMediationVungle', '7.4.2.0'
      google.dependency 'GoogleMobileAdsMediationFacebook', '6.15.2.1'
      google.dependency 'GoogleMobileAdsMediationUnity', '4.12.3.1'
      google.dependency 'GoogleMobileAdsMediationChartboost', '9.7.0.1'
      google.dependency 'GoogleMobileAdsMediationAppLovin', '13.0.1.0'
      google.dependency 'GoogleMobileAdsMediationPangle', '6.2.0.9.0'
      ...
      google.dependency 'AmazonPublisherServicesSDK', '4.10.1'
      #google.dependency 'AmazonPublisherServicesAdMobAdapter', '3.0.5'
      google.dependency 'GoogleUserMessagingPlatform', '2.6.0'
...
#  end
  s.subspec 'Applovin' do |applovin|
      ...
      #    ]
      applovin.dependency 'AppLovinSDK', '13.0.0'#'11.11.4' #'6.15.1'#, '6.12.0' #'6.11.4' #'6.10.1' #'6.9.5'
...
#      login.dependency 'Weibo_SDK'
  ...
  s.subspec 'ThinkingData' do |tdata|
    path = "IvyiOSSdk/Classes/ThinkingSdk/Sources"
#    tdata.ios.deployment_target = '9.0'
    tdata.source_files = 'IvyiOSSdk/Classes/ThinkingSdk/*.{h,m}', path + '/EventTracker/**/**/*.{h,m}', path + '/Hook/**/*.{h,m}', path + '/Config/**/*.{h,m}', path + '/DeviceInfo/**/*.{h,m}', path + '/main/**/*.{h,m}', path + '/Store/**/*.{h,m}', path + '/Network/**/*.{h,m}', path + '/AppLaunch/**/*.{h,m}', path + '/AutoTrack/**/*.{h,m}', path + '/Encrypt/**/*.{h,m}', path + '/Exception/**/*.{h,m}',  path + '/AppLifeCycle/**/*.{h,m}',  path + '/ExtensionAnalyticsPlugin/**/*.{h,m}', path + '/PresetProperty/**/*.{h,m}', path + '/Util/**/*.{h,m}', path + '/Toast/**/*.{h,m}', path + '/Logger/**/*.{h,m}', path + '/Collections/**/*.{h,m}', path + '/CalibratedTime/**/*.{h,m,c}'
    tdata.frameworks = 'CoreTelephony', 'UIKit', 'Foundation'
#    tdata.libraries        = 'sqlite3', 'z'
    tdata.dependency 'ThinkingDataCore', '1.0.2'
    tdata.xcconfig = { "OTHER_LDFLAGS" => '-ObjC' }
    tdata.dependency 'IvyiOSSdk/Core'
  end
