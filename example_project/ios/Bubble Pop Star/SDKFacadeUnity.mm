...
- (void)onNotificationPermissionState:(int)state
{
    Send("IvySdkListener", "onNotificationPermissionState", @(state).stringValue.UTF8String);
}

-(void)on3DTouchEvent:(NSString *)type
{
    type = type ? type : @"{}";
    const char * _msg = [type UTF8String];
    Send("IvySdkListener", "onReceivedFilterAction", _msg);
}

-(void)onHaveToRequestATT
{
    Send("IvySdkListener", "onHaveToRequestATT", "");
}

-(void)onHaveToRequestGDPR
{
    Send("IvySdkListener", "onHaveToRequestGDPR", "");
}

-(void)onInitialized
{
    Send("IvySdkListener", "onInitialized", "");
}

-(void)onNetworkChanged:(int)status
{
    Send("IvySdkListener", "onNetworkChanged", @(status).stringValue.UTF8String);
}
...
-(void)onReceiveServerExtra:(NSString *)data
{
    ...
    Send("IvySdkListener", "onReceiveServerExtra", _msg);
}
...
-(void)onReceiveNotificationData:(NSString *)data
{
    data = data ? data : @"{}";
    const char * _msg = [data UTF8String];
    Send("IvySdkListener", "onReceiveNotificationData", _msg);
}
...
-(void)onDeepLinkReceived:(NSURL *)url
{
    if (url) {
        ...
        Send("IvySdkListener", "onDeepLinkReceived", _msg);
    }
}
    
-(void)onAttAccepted:(BOOL)isAccept {
    Send("IvySdkListener", "onAttAccepted", isAccept ? "0": "1");
}
    
-(void)unreadMessageCount:(int) count {
    Send("IvySdkListener", "unreadMessageCount",  @(count).stringValue.UTF8String);
}

-(void)onNotificationOpen:(BOOL)isOpen {
    Send("IvySdkListener", "onNotificationOpen", isOpen ? "0": "1");
}

-(void)onThirdLoginSuccess:(NSString * _Nonnull)openId platformType:(NSString * _Nonnull)platform
{
    Send("IvySdkListener", "onReceiveLoginResult", "0");
}
...
{
    Send("IvySdkListener", "onReceiveLoginResult", "1");
}
...
- (void)deliciousIconClick:(NSString *)bannerDownPath jumpURL:(NSString *)url
{
    ...
    Send("IvySdkListener", "deliciousIconClick", _msg);
}

- (void)onPaymentReady
{
    Send("IvySdkListener", "onPaymentReady", "");
}

- (void)onPaymentSuccess:(int)paymentId merchantTransactionId:(nullable NSString*)merchantTransactionId
{
    NSString * merchant = merchantTransactionId ?: @"";
    const char * _msg = [[NSString stringWithFormat:@"%d|%@", paymentId, merchant] UTF8String];
    Send("IvySdkListener", "onPaymentSuccess", _msg);
}

- (void)onPaymentSuccess:(int)paymentId payload:(NSString *)payload merchantTransactionId:(nullable NSString*)merchantTransactionId
{
    NSString * merchant = merchantTransactionId ?: @"";
    const char * _msg = [[NSString stringWithFormat:@"%d|%@|%@", paymentId, payload, merchant] UTF8String];
    Send("IvySdkListener", "onPaymentSuccessWithPayload", _msg);
}
...
{
    NSString * merchant = merchantTransactionId ?: @"";
    const char * _msg = [[NSString stringWithFormat:@"%d|%@|%@|%@", paymentId, payload, merchant, orderInfo] UTF8String];
    Send("IvySdkListener", "onPaymentSuccessWithPayloadAndOrderInfo", _msg);
}

- (void)onPaymentFailure:(int)paymentId forError:(NSString *)error merchantTransactionId:(nullable NSString*)merchantTransactionId
{
    NSString * merchant = merchantTransactionId ?: @"";
    const char * _msg = [[NSString stringWithFormat:@"%d|%@", paymentId, merchant] UTF8String];
    Send("IvySdkListener", "onPaymentFailure", _msg);
}

-(void)onAppStorePayRequest:(int)paymentId
{
    const char * _msg = [[@(paymentId) stringValue] UTF8String];
    Send("IvySdkListener", "onAppStorePayRequest", _msg);
}
...
- (void)onCheckSubscriptionResult:(int)paymentId remainSeconds:(long)remainSeconds
{
    ...
    Send("IvySdkListener", "onCheckSubscriptionResult", _msg);
}

-(void)onRestoreSuccess:(int)paymentId
{
    const char * _msg = [[@(paymentId) stringValue] UTF8String];
    Send("IvySdkListener", "onRestoreSuccess", _msg);
}

-(void)onRestoreFailure:(NSString *)error
{
    const char * _msg = error ? [error UTF8String] : "";
    Send("IvySdkListener", "onRestoreFailure", _msg);
}

-(void)signInAppleSuccess:(NSString *)appleUID
{
    const char * _msg = appleUID ? [appleUID UTF8String] : "";
    Send("IvySdkListener", "signInAppleSuccess", _msg);
}

-(void)signInAppleFailure:(NSString *)error
{
    const char * _msg = error ? [error UTF8String] : "";
    Send("IvySdkListener", "signInAppleFailure", _msg);
}

-(void)onGameCenterLoginSuccess:(NSString *)playerId
{
    Send("IvySdkListener", "onGameCenterLoginSuccess", playerId ? [playerId UTF8String] : "");
}

-(void)onGameCenterLoginFailure
{
    Send("IvySdkListener", "onGameCenterLoginFailure", "");
}

-(void)snsShareSuccess
{
    Send("IvySdkListener", "snsShareSuccess", "");
}

-(void)snsLoginCancel
{
    Send("IvySdkListener", "snsLoginCancel", "");
}

-(void)snsShareFailure
{
    Send("IvySdkListener", "snsShareFailure", "");
}

-(void)snsShareCancel
{
    Send("IvySdkListener", "snsShareCancel", "");
}
...
{
    Send("IvySdkListener", "onWebviewLoadSuccess", "");
}

- (void)onWebviewLoadFailure
{
    Send("IvySdkListener", "onWebviewLoadFailure", "");
}

-(void)onWebviewClose
{
    Send("IvySdkListener", "onWebviewClose", "");
}
...
- (void)onCloudFunctionFailed:(nullable NSString *)data {
    ...
    Send("IvySdkListener", "onCloudFunctionFailed", _msg);
}
...
- (void)onCloudFunctionResult:(nullable NSString *)data {
    ...
    Send("IvySdkListener", "onCloudFunctionResult", _msg);
}
...
- (void)onFirestoreConnectError:(nullable NSString *)data {
    ...
    Send("IvySdkListener", "onFirestoreConnectError", _msg);
}
...
- (void)onFirestoreConnected:(nullable NSString *)data {
    ...
    Send("IvySdkListener", "onFirestoreConnected", _msg);
}
...
- (void)onFirestoreData:(nullable NSString *)collection data:(nullable NSString *)data {
    ...
    Send("IvySdkListener", "onFirestoreReadData", _msg);
}
...
- (void)onFirestoreSnapshot:(nullable NSString *)data {
    ...
    Send("IvySdkListener", "onFirestoreSnapshot", _msg);
}
...
- (void)onFirestoreSuccess:(nullable NSString *)operation data:(nullable NSString *)data {
    ...
    Send("IvySdkListener", [operation UTF8String], _msg);
}
...
- (void)onChatMessage:(nonnull NSString *)data {
    ...
    Send("IvySdkListener", "onChatMessage", _msg);
}
...
- (void)inAppMessageEvent:(nonnull NSString *)data {
    ...
    Send("IvySdkListener", "onInAppMessageEvent", _msg);
}
...
- (void)onInAppMessageDisplayed:(nonnull NSString *)data {
    ...
    Send("IvySdkListener", "onInAppMessageDisplayed", _msg);
}
...
- (void)onRequireWeChatLogin:(nullable NSString *)data
{
    data = data ? data : @"{}";
    const char * _msg = [data UTF8String];
    Send("IvySdkListener", "RequireWXLogin", _msg);
}
...
- (void)onCloudFuncSuccess:(nonnull NSString *)data
{
    data = data ? data : @"{}";
    const char * _msg = [data UTF8String];
    Send("IvySdkListener", "cloudFuncSuccess", _msg);
}
...
- (void)onCloudFuncFail:(nonnull NSString *)data
{
    data = data ? data : @"{}";
    const char * _msg = [data UTF8String];
    Send("IvySdkListener", "cloudFuncFail", _msg);
}
...
- (void)onWeChatLogSuccess:(NSString *)data
{
    data = data ? data : @"{}";
    const char * _msg = [data UTF8String];
    Send("IvySdkListener", "onWXLogSuccess", _msg);
}
...
- (void)onWeChatLogFailed:(NSString *)data
{
    data = data ? data : @"{}";
    const char * _msg = [data UTF8String];
    Send("IvySdkListener", "onWXLogFailed", _msg);
}
...
- (void)onWeChatNotInstall:(NSString *)data
{
    data = data ? data : @"{}";
    const char * _msg = [data UTF8String];
    Send("IvySdkListener", "onWXUninstall", _msg);
}
...
- (void)onWeChatPreLogState:(NSString *)data
{
    data = data ? data : @"{}";
    const char * _msg = [data UTF8String];
    Send("IvySdkListener", "onWXPreLogState", _msg);
}
...
- (void)onUserProtocol:(NSString *)data
{
    data = data ? data : @"{}";
    const char * _msg = [data UTF8String];
    Send("IvySdkListener", "onUserProtocol", _msg);
}

- (void)IdVerifySuccess
{
    const char * _msg = [@"{}" UTF8String];
    Send("IvySdkListener", "IdVerifySuccess", _msg);
}
...
- (void)IdVerifyFailed:(NSString *)reason
{
    ...
    Send("IvySdkListener", "IdVerifyFailed", _msg);
}
...
extern "C" {
    ...
    void onCreate()
    {
        ...
        [[SDKFacade sharedInstance] setOnIdCardVerifiedDelegate:^{
            Send("IvySdkListener", "onIdCardVerified", "");
        }];
    ...
    void showSingleFAQ(const char* faqId, int moment){
    ...
    void shippingGoods(const char* merchant_transaction_id)
    {
        if (merchant_transaction_id != NULL) {
            [[SDKFacade sharedInstance] shippingGoods:[NSString stringWithUTF8String:merchant_transaction_id]];
        }
    }
...
//    }
    ...
    bool isAppleSigned()
    {
        return [[SDKFacade sharedInstance] isAppleSigned];
    }
...
void logAppsflyerEventWithData(const char *name, const char *data)
{
    if(name != NULL) {
        NSString *objc_name = [NSString stringWithUTF8String:name];
        if(data != NULL) {
            ...
            if(arr && arr.count > 1) {
                ...
                [[SDKFacade sharedInstance] logAppsflyrEvent:objc_name withData:objc_data];
            } else {
                [[SDKFacade sharedInstance] logAppsflyrEvent:objc_name];
            }
        } else {
            [[SDKFacade sharedInstance] logAppsflyrEvent:objc_name];
        }
...
// InAppMessage
    ...
    void cacheUrlWithTag(const char* tag, const char* url)
    {
        ...
        [[SDKFacade sharedInstance] cacheUrl:_tag url:_url succes:^(NSString * __tag, NSString * __path) {
            ...
            Send("IvySdkListener", "cacheUrlSuccess", _msg);
        } failure:^(NSString * __tag) {
            Send("IvySdkListener", "cacheUrlFailure", [__tag UTF8String]);
        }];
    }
    ...
    void getNotificationPermissionState(){
        [[SDKFacade sharedInstance] getNotificationPermissionState];
    }

    void requestNotificationPermission(){
        [[SDKFacade sharedInstance] requestNotificationPermission];
    }

    void openNotificationSettings(){
        [[SDKFacade sharedInstance] openNotificationSettings];
    }
...
//    }
    ...
    void requestPhotoWritePermission()
    {
        [[SDKFacade sharedInstance] requestPhotoWritePermission:^(BOOL permit) {
            Send("IvySdkListener", "requestPhotoWritePermissionResult", permit ? "1" : "0");
        }];
    }
    ...
    void stopRecording()
    {
        [[SDKFacade sharedInstance] stopRecording:^(BOOL result) {
            ...
            Send("IvySdkListener", "onRecordingStoped", _msg);
        }];
    }
    ...
    void editVideo(const char* _Nonnull path)
    {
        ...
        [[SDKFacade sharedInstance] editVideo:obj_path complete:^(NSString * _Nullable localIdent) {
            ...
            Send("IvySdkListener", "onEditVideoComplete", _msg);
        }];
    }
    ...
    void sharePhotos(const char* _Nonnull photoIdentifiers)
    {
        ...
        [[SDKFacade sharedInstance] sharePhotos:arr result:^(BOOL success, NSString * _Nullable error) {
            const char * _msg = error? [error UTF8String] : "";
            if (success) {
                Send("IvySdkListener", "onSharePhotosSuccess", _msg);
            } else {
                Send("IvySdkListener", "onSharePhotosFailure", _msg);
            }
        }];
    }
    ...
    void shareVideos(const char* _Nonnull photoIdentifiers)
    {
        ...
        [[SDKFacade sharedInstance] shareVideos:arr result:^(BOOL success, NSString * _Nullable error) {
            const char * _msg = error? [error UTF8String] : "";
            if (success) {
                Send("IvySdkListener", "onShareVideosSuccess", _msg);
            } else {
                Send("IvySdkListener", "onShareVideosFailure", _msg);
            }
        }];
    }
    ...
    int checkIDFAAuthorizationStatus(){
        return [SDKFacade checkIDFAAuthorizationStatus];
    }
...
# pragma mark ThirdLogin methods
    ...
    const char* _Nullable getAfInviteId()
    {
//        NSString* inviteId = [[SDKFacade sharedInstance] getAfInviteId];
//        if (inviteId != nil) {
//            return returnStr([inviteId UTF8String]);
//        }
        return nil;
    }

    void inviteUserByAf(const char* _Nonnull currentUserId) {
//        [[SDKFacade sharedInstance] inviteUserByAf:[NSString stringWithUTF8String:currentUserId]];
    }
    ...
    void addShortcut(const char* _Nonnull type, const char* _Nonnull title, const char* subtitle, const char* icon){
        NSString * _type = [NSString stringWithUTF8String:type];
        NSString * _title = [NSString stringWithUTF8String:title];
        NSString * _subtitle = [NSString stringWithUTF8String:subtitle];
        NSString * _icon = [NSString stringWithUTF8String:icon];
        [[SDKFacade sharedInstance] addShortcut:_type title:_title subtitle:_subtitle icon:_icon];
    }

    void deleteShortcut(const char* _Nonnull type){
        NSString * _type = [NSString stringWithUTF8String:type];
        [[SDKFacade sharedInstance] deleteShortcut:_type];
    }
