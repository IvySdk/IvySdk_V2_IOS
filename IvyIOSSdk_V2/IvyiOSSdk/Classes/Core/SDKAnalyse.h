...
-(void)logPay:(nonnull NSString *)payId price:(nonnull NSNumber *)price name:(nonnull NSString *)itemName number:(int)number currency:(nonnull NSString *)currency first_purchase:(BOOL)first_purchase;
