...
public:
    ...
    virtual void onNotificationPermissionState(int state){}
    virtual void on3DTouchEvent(const char * _Nonnull type){}
};
...
public:
    ...
    virtual void onHaveToRequestATT() {};
};
...
public:
    ...
    static void getNotificationPermissionState();
    ...
    static void pushLocalDelayNotification(const char* _Nonnull key, const char* _Nonnull title, const char* _Nonnull msg, long pushTime, long interval, bool repeat, bool useSound, const char* _Nullable soundName, const char* _Nonnull userInfo);
    ...
    static int checkIDFAAuthorizationStatus();
    ...
    static void openFacebook(const char* _Nonnull name);
    static void vibrate(int degree);
    static void addShortcut(const char* _Nonnull type, const char* _Nonnull title, const char* _Nullable subtitle, const char* _Nullable icon);
    static void deleteShortcut(const char* _Nonnull type);
