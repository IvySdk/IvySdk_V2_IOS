...
{
    [self adDidShown];
    [[SDKFacade sharedInstance] logEvent:@"sdk_ad_shown" withData:@{@"ad_format":@"banner", @"ad_unit":_adId,@"event_src":@"sdk"}];
}

- (void)adDidClick
{
    [super adDidClick];
    [[SDKFacade sharedInstance] logEvent:@"sdk_ad_clicked" withData:@{@"ad_format":@"banner", @"ad_unit":_adId,@"event_src":@"sdk"}];
}
