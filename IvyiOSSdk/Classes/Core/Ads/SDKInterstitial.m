...
//    [[SDKFacade sharedInstance] logEvent:@"sdk_ad_shown" withData:@{@"ad_formt":@"interstitial",@"ad_unit":_adId,@"event_src":@"sdk"}];
}
...
-(void)adDidClick
{
 ...
 //   [[SDKFacade sharedInstance] logEvent:@"sdk_ad_clicked" withData:@{@"ad_formt":@"interstitial",@"ad_unit":_adId,@"event_src":@"sdk"}];
}
...
-(void)adDidClose
{
    ...
    [super adDidClose];
  //  [[SDKFacade sharedInstance] logEvent:@"sdk_ad_closed" withData:@{@"ad_formt":@"interstitial",@"ad_unit":_adId,@"event_src":@"sdk"}];
}
@end
