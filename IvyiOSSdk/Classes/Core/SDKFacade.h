...
-(void)shippingGoods:(nullable NSString *)merchant_transaction_id;
...
-(void)pushLocalDelayNotification:(nonnull NSString *)key title:(nonnull NSString *)title msg:(nonnull NSString *)msg pushTime:(NSTimeInterval)seconds interval:(NSTimeInterval)interval repeat:(BOOL)repeat useSound:(BOOL)useSound soundName:(nullable NSString *)soundName userInfo:(nullable NSDictionary *)userInfo;
/** 发送本地通知
...
-(void)logAppsflyrEvent:(nullable NSString *)eventId;
-(void)logAppsflyrEvent:(nonnull NSString *)eventId withData:(nullable NSDictionary<NSString *, id> *) data;
...
-(void) mmSetDoubleValue:(nonnull NSString *)key value:(double)value;
-(double) mmGetDoubleValue:(nonnull NSString *)key defaultValue:(double)defaultValue;
...
-(void)cloudFunc:(nullable NSString *)funcKey params:(nullable NSDictionary *)params;
-(void)cloudFuncWithoutLogin:(nullable NSString *)funcKey params:(nullable NSDictionary *)params;
-(void)idCardVerify:(nullable NSString *)name card:(nullable NSString *)card;
...
-(nullable NSString *)getAfInviteId;
-(void)inviteUserByAf:(nonnull NSString *)currentUserId;

-(void)addShortcut:(nonnull NSString *)type title:(nonnull NSString *)title subtitle:(nullable NSString *)subtitle icon:(nullable NSString *)icon;
-(void)deleteShortcut:(nonnull NSString *)type;



+(void)openFacebook:(nonnull NSString *)pageId;
+(void)getApp:(nonnull NSString *)appstoreId;
